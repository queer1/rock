...
<html>
	...
	<body>
		<a href="#show-tuning" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-tuning" class="content scaffold-show" role="main">
			...
			<ol class="property-list tuning">
				...
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="tuning.name.label" default="Name" /></span>
						...
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${tuningInstance}" field="name"/></span>
			...
			<g:form url="[resource:tuningInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${tuningInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
