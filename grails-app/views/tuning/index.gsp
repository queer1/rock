...
<html>
	...
	<body>
		<a href="#list-tuning" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
			...
			<thead>
				...
				<g:each in="${tuningInstanceList}" status="i" var="tuningInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${tuningInstance.id}">${fieldValue(bean: tuningInstance, field: "name")}</g:link></td>
