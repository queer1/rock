			...
			<ol class="property-list song">
				...
				<li class="fieldcontain">
					<span id="band-label" class="property-label"><g:message code="song.band.label" default="Band" /></span>
						...
						<span class="property-value" aria-labelledby="band-label"><g:link controller="band" action="show" id="${songInstance?.band?.id}">${songInstance?.band?.encodeAsHTML()}</g:link></span>
