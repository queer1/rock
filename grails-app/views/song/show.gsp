			...
			<ol class="property-list song">
				...
				<li class="fieldcontain">
					<span id="band-label" class="property-label"><g:message code="song.band.label" default="Band" /></span>
						...
						<span class="property-value" aria-labelledby="band-label"><g:link controller="band" action="show" id="${songInstance?.band?.id}">${songInstance?.band?.name}</g:link></span>
				...
				<g:if test="${songInstance?.tuning}">
					<li class="fieldcontain">
						<span id="tuning-label" class="property-label"><g:message code="song.tuning.label" default="Tuning" /></span>

						<span class="property-value" aria-labelledby="tuning-label"><g:link controller="tuning" action="show" id="${songInstance?.tuning?.id}">${songInstance?.tuning?.name}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="playedArcade-label" class="property-label"><g:message code="song.playedArcade.label" default="Played Arcade" /></span>

						<span class="property-value" aria-labelledby="playedArcade-label"><g:fieldValue bean="${songInstance}" field="playedArcade"/></span>
				...
				<li class="fieldcontain">
					<span id="playedNormal-label" class="property-label"><g:message code="song.playedNormal.label" default="Played Normal" /></span>

						<span class="property-value" aria-labelledby="playedNormal-label"><g:fieldValue bean="${songInstance}" field="playedNormal"/></span>
				...
				<li class="fieldcontain">
					<span id="scores-label" class="property-label"><g:message code="song.scores.label" default="Scores" /></span>
